...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>PA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Peserta</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('/calon')}}"><i class="fa fa-dashboard"></i> <span>Beranda</span></a></li>
        <li><a href="{{url('/calon/isibio')}}"><i class="fa fa-edit"></i> <span>Isi Biodata</span></a></li>
